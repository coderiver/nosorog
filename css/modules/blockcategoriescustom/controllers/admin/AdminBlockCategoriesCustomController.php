 ...
 * @since 1.6.0
 */
class AdminBlockCategoriesCustomController extends ModuleAdminController
{
	public function postProcess()
	{
		if (($id_thumb = Tools::getValue('deleteThumb', false)) !== false)
		{
			...
			Tools::redirectAdmin(Context::getContext()->link->getAdminLink('AdminCategoriesCustom').'&id_category='
