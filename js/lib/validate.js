...
function validate_isPasswdConfirmed(s, rubbish, element) {
    if (element.data('equalto')) {
        var form = element.closest('form');
        if (form.length) {
            var equalElm = $('#' + element.data('equalto'), form);
            return equalElm.val() == element.val();
        }
    }
...
$(document).on('focusout', 'input.validate, textarea.validate', function() {
    if ($(this).hasClass('is_required') || $(this).val().length) {
        if ($(this).attr('name') == 'postcode' && typeof(countriesNeedZipCode[$('#id_country option:selected').val()]) != 'undefined') {
            var result = window['validate_' + $(this).attr('data-validate')]($(this).val(), countriesNeedZipCode[$('#id_country option:selected').val()], $(this));
        } else {
            var result = window['validate_' + $(this).attr('data-validate')]($(this).val(), false, $(this));
        }
